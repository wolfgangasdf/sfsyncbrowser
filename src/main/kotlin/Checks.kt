...
object Checks {
    fun checkComparedFile() {
        ...
        ces += CheckEntry(A_ISEQUAL, "", SyncEntry(A_UNCHECKED, mod0, s0, mod0, s0, mod0, mod0, s0, true, true))
        ces += CheckEntry(A_USELOCAL, "newf/", SyncEntry(A_UNCHECKED, mod1, s1, -1, -1, -1, -1, -1, true, true))
